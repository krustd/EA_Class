...
% =================== I. TITLE ===================
\section{I. Title (Name of a Business)}
\textbf{Luckin Coffee Inc.} --- A Technology-Driven Coffee Chain and New Retail Enterprise.

% =================== II. GROUP MEMBERS ===================
\section{II. Names of the Members, Group Name}
\textbf{Group Name:} Group 4 \\
\textbf{Members:} Zhe-Kai Yang (Krust), Shi-Hang Chen (Sean), Wei-Yu Cai (Nosta), Huan-Wen Chen (Evan), Yuan-Yong Liao (Foreve).

% =================== III. EFQM CRITERIA ===================
\section{III. EFQM Quality Management Approach}
