...
\vspace{0.2cm}
\caption{Relational data model diagram for customer, order, campaign, and fulfilment relations. Underlined attributes are primary-key attributes; FK marks foreign-key references; endpoint labels show cardinality, while bridge tables resolve M:N relationships.}
\end{minipage}
\end{figure}
\end{landscape}
\restoregeometry
...
\vspace{0.2cm}
\caption{Relational data model diagram for product, recipe, material, inventory, and supplier relations. Underlined attributes are primary-key attributes; FK marks foreign-key references; endpoint labels show cardinality, while bridge tables resolve M:N relationships.}
\end{minipage}
\end{figure}
\end{landscape}
\restoregeometry
