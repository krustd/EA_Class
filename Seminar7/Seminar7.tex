...
\begin{figure}[H]
  ...
  \caption{Store-count and revenue-growth evidence reused from the Seminar 1 case background.}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Stakeholder map reused from the Seminar 1 report.}
\end{figure}
...
EFQM is a quality-management approach that evaluates an organization through enablers and results. For Luckin, the model helps connect strategic ambition with daily execution and measurable outcomes.
...
\caption{Business Layer Model from Seminar 6.}
\end{figure}
...
\caption{Application Layer Model from Seminar 6.}
\end{figure}
...
\caption{Technology Layer Model from Seminar 6.}
\end{figure}
